...
@Component({
  template: `<app-puzzle
    ...
    flavour="You've finally arrived at your seaside holiday destination in that beautiful Commonwealth nation! Except... something's wrong here. Was that the right flight? Or did you take a bad turn somewhere?"
  >
